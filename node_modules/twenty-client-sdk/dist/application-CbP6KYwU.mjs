...
var o = "6ba7b810-9dad-11d1-80b4-00c04fd430c8", s = "6ba7b811-9dad-11d1-80b4-00c04fd430c8";
function c(e, t, r, o, s, c) {
	let l = typeof r == "string" ? a(r) : r, u = typeof o == "string" ? n(o) : o;
	if (typeof o == "string" && (o = n(o)), o?.length !== 16) throw TypeError("Namespace must be array-like (16 iterable integer values, 0-255)");
	let d = new Uint8Array(16 + l.length);
	if (d.set(u), d.set(l, u.length), d = t(d), d[6] = d[6] & 15 | e, d[8] = d[8] & 63 | 128, s) {
...
function d(e) {
	...
	for (let e = 0; e < a; ++e) {
		...
		for (let e = 16; e < 80; ++e) r[e] = u(r[e - 3] ^ r[e - 8] ^ r[e - 14] ^ r[e - 16], 1);
		let i = n[0], a = n[1], s = n[2], c = n[3], d = n[4];
		for (let e = 0; e < 80; ++e) {
			let n = Math.floor(e / 20), o = u(i, 5) + l(n, a, s, c) + d + t[n] + r[e] >>> 0;
			d = c, c = s, s = u(a, 30) >>> 0, a = i, i = o;
		}
		n[0] = n[0] + i >>> 0, n[1] = n[1] + a >>> 0, n[2] = n[2] + s >>> 0, n[3] = n[3] + c >>> 0, n[4] = n[4] + d >>> 0;
	}
...
function f(e, t, n, r) {
	return c(80, d, e, t, n, r);
}
f.DNS = o, f.URL = s;
//#endregion
//#region ../twenty-shared/dist/application.mjs
var p = "TWENTY_API_KEY", m = "TWENTY_API_URL", h = "TWENTY_APP_ACCESS_TOKEN";
//#endregion
