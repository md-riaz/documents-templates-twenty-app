...
export default defineObject({
  ...
  fields: [
    ...
    { universalIdentifier: TEMPLATE_VERSION_FIELDS.createdBy, type: FieldType.TEXT, name: 'createdBy', label: 'Created By', description: 'User id or display name that created the version', icon: 'IconUser', isNullable: true, defaultValue: null },
  ],
});
