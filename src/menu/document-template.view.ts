...
export default defineView({
  ...
  fields: [
    ...
    { universalIdentifier: 'ac0a7bb6-f9a2-4fa7-9149-d59c6e14f085', fieldMetadataUniversalIdentifier: DOCUMENT_TEMPLATE_FIELDS.status, position: 1, size: 120 },
    { universalIdentifier: '9169b0b1-2e9d-4275-a5df-8f278b7c5ea1', fieldMetadataUniversalIdentifier: DOCUMENT_TEMPLATE_FIELDS.version, position: 2, size: 90 },
    { universalIdentifier: 'a7573e8d-c5cb-44b0-a74a-9d9730cf9293', fieldMetadataUniversalIdentifier: DOCUMENT_TEMPLATE_FIELDS.boundObjectName, position: 3, size: 120 },
  ],
  sorts: [
